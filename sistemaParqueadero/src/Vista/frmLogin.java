...
public class frmLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(222, 236, 121));

        jLabel1.setText("Usuario");

        jLabel2.setText("Contraseña");

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Archivos/user.png"))); // NOI18N

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Archivos/pass.png"))); // NOI18N

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Archivos/login.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            if (func.totalRegistros>0) {
                ...
                frmInicio.lblApellidop.setText(tablaListado.getValueAt(0, 2).toString());
                frmInicio.lblApellidom.setText(tablaListado.getValueAt(0, 3).toString());
                frmInicio.lblAcceso.setText(tablaListado.getValueAt(0, 4).toString());
                
                if (!frmInicio.lblAcceso.getText().equals("Administrador")) {
                    frmInicio.mnArchivo.setEnabled(false);
                }
            }
            else{
