...
public class fReserva {
    ...
    public DefaultTableModel mostrar(String buscar) {
        ...
        String[] titulos = {"ID", "Vehículo", "Trabajador", "Ingreso", "Salida", "Tiempo Total", "diai", "mesi", "anoi",  "horai",  "mini",
            "diaf", "mesf", "anof",  "horaf",  "minf", "tiempoT", "Vlr Minuto", "Valor Total", "Estado"};
